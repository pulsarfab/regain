...
const HELP: &str = "ZWOgain SDK camera commands:
  zwogain-host --list [--sdk /absolute/path/to/library]
  zwogain-host --inspect [--camera NAME] [--serial HEX]
  zwogain-host --capture --output NEW_DIRECTORY [--camera NAME] [--serial HEX]
