...
fn main() -> Result<()> {
    ...
    if simulate {
        let mut caa = Caa::connect(regain_caa::simulation::Sim::default())?;
...
fn serve<T: regain_caa::Transport>(caa: Caa<T>) -> Result<()> {
