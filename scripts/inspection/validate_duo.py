...
def capture(options, guide=False, asi6200=False, worker=None, asi2600_p25=False):
    command = [str(worker or ROOT / 'target/debug/regain-device.exe'), 'zwo', 'camera-direct', '--capture-2600-p25' if asi2600_p25 else '--capture-6200' if asi6200 else '--capture-guide' if guide else '--capture-duo', '--stream']
