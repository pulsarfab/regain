...
{
    string[] required = ["ZwoGain.NINA.dll", "ZwoGain.Core.dll", "ZwoGain.Rotator.dll", "zwogain-caa.exe", "zwogain-accessories.exe", "zwogain-ofp2.exe", "caa.md", "zwogain-host.exe", "zwogain-direct.exe", "zwogain-camera.exe", "zwogain-alpaca.exe", "ASICamera2.dll",
