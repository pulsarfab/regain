...
correction: integer averages of 2Ã—2, 3Ã—3 or 4Ã—4 pixels, without saturation.
...
three same-exposure comparisons: 512 Ã— 256 at origin, full 6248 Ã— 4176, and a
512 Ã— 256 window at (16, 32). The full sensor map contained 26,091 defects;
...
The acquisition matrix covers 64Ã—64 through 6248Ã—4176, moved ROI, 32 Âµs,
999,999 Âµs, 1 s, 2 s and 30 s, gains âˆ’25 through 700, offsets 0 through 240,
bins 1â€“4, and repeated fresh captures. See the sanitized evidence JSON and
...
empirical 100 ms guard resolved the tested 64Ã—64 case. Sensor standby uses
...
512Ã—256, gain 0 at full 1920Ã—1080 and gain 0 with full-sensor bin 2. Independent
...
the binary IPC payloads. A 64Ã—64, 32 Âµs capture also failed in the SDK;
