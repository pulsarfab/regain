...
```powershell
target/release/regain-device.exe zwo camera-direct --capture-2600-p25 --gain 100 --offset 50 --reopen-after-bytes 12582912 --reopen-delay-ms 1000 --replay
target/release/regain-device.exe zwo camera-direct --capture-2600-p25 --keep-retained
target/release/regain-device.exe zwo camera-direct --verify-retained-2600-p25 --expected-wire-sha256 HASH
```
...
```powershell
target/release/regain-device.exe zwo camera-direct --reset-port-2600-p25
target/release/regain-device.exe zwo camera-direct --cycle-port-2600-p25
```
