...
internal static class SharedDevice
{
    ...
    internal static readonly AccessorySession Session = new(
        Regain.Rotator.RegainPaths.EnvironmentVariable("REGAIN_FC3_WORKER") ?? Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "regain-fc3.exe"),
...
public sealed class Driver : IFocuserV3
{
    ...
    public string Name => "PulsarFab regain Pegasus FocusCube3";
