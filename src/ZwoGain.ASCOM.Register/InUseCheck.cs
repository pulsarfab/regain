...
internal static class InUseCheck
{
    ...
    {
        var files = new[] { "ZwoGain.ASCOM.dll", "ZwoGain.Rotator.dll", "zwogain-caa.exe", "zwogain-accessories.exe", "zwogain-ofp2.exe", "zwogain-fc3.exe", "ZwoGain.FocusCube.ASCOM.exe", "zwogain-camera.exe", "zwogain-alpaca.exe", "zwogain-host.exe", "zwogain-direct.exe" }
