...
internal static class InUseCheck
{
    ...
    {
        var files = new[] { "Regain.ASCOM.dll", "Regain.Rotator.dll", "regain-caa.exe", "regain-accessories.exe", "regain-ofp2.exe", "regain-fc3.exe","regain-eta.exe", "Regain.FocusCube.ASCOM.exe", "Regain.Ofp2.ASCOM.exe","Regain.Eta.ASCOM.exe", "regain-camera.exe", "regain-alpaca.exe", "regain-host.exe", "regain-direct.exe" }
